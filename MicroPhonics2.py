...
#        if (len(cavNumA) + len(cavNumB)) > 2:
#            self.ui.AcqProg.setText("Only 1 cavity can be selected at a time. Try again")
#        print(cavNumA, cavNumB)        
        if cavNumA!='' or cavNumB!='':
            ...
            s1 = datetime.datetime.now().strftime("%Y%m%d"+"_"+"%H%M%S")
...
#  Comment Out the print command and uncomment the next two lines to execute shell command
                print(prStr)
...
# #             
        with scandir(lastPath) as dirs:
            for entry in dirs:
                ...
                #dFDat, throwAway = FFt_math.readCavDat("5678_20210617_1227")
...
#     #            cavsAll = self.ui.Cavs58.isChecked() and self.ui.Cavs14.isChecked()
        ...
        if indexPlot ==1:
                ...
                if '1' in cavNumA:
                    ...
                    leGend.append('Cav1')
                if '2' in cavNumA:
                    ac.axes.hist(cavDat1, bins=140,  histtype='step', log='True', edgecolor='r')
                    leGend.append('Cav2')
                if '3' in cavNumA:
                    ac.axes.hist(cavDat1, bins=140,  histtype='step', log='True', edgecolor='g')
                    leGend.append('Cav3')
                if '4' in cavNumA:
                    ac.axes.hist(cavDat1, bins=140,  histtype='step', log='True', edgecolor='c')
                    leGend.append('Cav4')
                if '5' in cavNumB:
                    ac.axes.hist(cavDat1, bins=140,  histtype='step', log='True', edgecolor='m')
                    leGend.append('Cav5')
                if '6' in cavNumB:
                    ac.axes.hist(cavDat1, bins=140,  histtype='step', log='True', edgecolor='y')
                    leGend.append('Cav6')
                if '7' in cavNumB:
                    ac.axes.hist(cavDat1, bins=140,  histtype='step', log='True', edgecolor='k')
                    leGend.append('Cav7')
                if '8' in cavNumB:
                    ac.axes.hist(cavDat1, bins=140,  histtype='step', log='True', edgecolor='w')                    
                    leGend.append('Cav8')
